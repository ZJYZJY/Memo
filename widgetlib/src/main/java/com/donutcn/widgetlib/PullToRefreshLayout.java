        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView
                        .setImageResource(R.drawable.refresh_succeed);
                break;
            case FAIL:
            default:
                // 刷新失败
                ...
                refreshStateImageView
                        .setImageResource(R.drawable.refresh_failed);
                break;
        }
        if (pullDownY > 0) {
            // 刷新结果停留1秒
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setImageResource(R.drawable.load_succeed);
                break;
            case FAIL:
            default:
                // 加载失败
                ...
                loadStateImageView.setImageResource(R.drawable.load_failed);
                break;
        }
        if (pullUpY < 0) {
            // 刷新结果停留1秒
...
//		pullUpView = loadmoreView.findViewById(R.id.pullup_icon);
    ...
    /**
     * refresh & load callback interface.
     *
     * @author chenjing
     */
