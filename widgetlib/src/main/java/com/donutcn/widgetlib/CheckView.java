...
class CheckView extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED = Color.parseColor("#43be4c");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#828282");//43be4c

    private static final int DEF_DRAW_SIZE = 20;
    private static final int DEF_ANIM_DURATION = 200;

    public static final int CIRCLE = 0;//draw circle
    public static final int SQUARE = 1;//draw square
    public int mShape = SQUARE;
    ...
    private void init(AttributeSet attrs) {
        ...
        mShape = ta.getInt(R.styleable.CheckBox_shape, 1);
        ta.recycle();
