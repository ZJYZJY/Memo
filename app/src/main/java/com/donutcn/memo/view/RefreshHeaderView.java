...
public class RefreshHeaderView extends FrameLayout implements IHeaderView {
    ...
    public void onPullingDown(float fraction, float maxHeadHeight, float headHeight) {
        ...
        float rotation = fraction * headHeight / maxHeadHeight * 720;
        refreshArrow.setRotation(rotation > 180 ? 180 : rotation);
    }
    ...
    public void onPullReleasing(float fraction, float maxHeadHeight, float headHeight) {
        if (fraction < 1f) {
            ...
            refreshArrow.setRotation(fraction * headHeight / maxHeadHeight * 720);
